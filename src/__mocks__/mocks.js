...
export const mockDatesObject = {
  "7 days": [{ month: 11, day: 16, year: 2019 }],
  "14 days": [{ month: 11, day: 16, year: 2019 }],
  "3 days": [{ month: 11, day: 16, year: 2019 }],
  "2 days": [{ month: 11, day: 16, year: 2019 }]
};

export const mockSortedPlants = {
  "7 days": [{ name: "Fiddle Leaf Fig", water_after: "7 days" }],
  "14 days": [{ name: "Snake Plant", water_after: "14 days" }],
  "3 days": [{ name: "Bird's Nest Fern", water_after: "3 days" }],
